...
/***/ function(module, exports, __webpack_require__) {
	...
	var _demo = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _i18n = __webpack_require__(235);
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'span',
	                            null,
	                            _i18n2.default.en['header-foundation']
	                        ),
	                        '.',
	                        _react2.default.createElement(
	                            'strong',
	                            null,
	                            _i18n2.default.en['header-component']
	                        )
	                    ),
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"header":"_2st8ieVOui-FuCD4gaLtTZ","header__wrapper":"JnK0uQW6wL9FEgOtBHIBB","header__logo":"_15c4kwIWKAX9n42e-BjhUF"};
...
/***/ function(module, exports) {
	...
	module.exports = {
		"ru": {
			"header-foundation": "UI-React",
			"header-component": "Swipe",
			"last": ""
		},
		"en": {
			"header-foundation": "UI-React",
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"nav":"_2wni1FZyVWCWFPPk2_8P0X","nav__link":"_3009WFOV798lehNNrkNEJO","nav__link_active":"_348Nse3N7YbZh5MKZxiDT2","nav__github-icon":"_2LqqckwXj8lcl1uGuO2DKJ"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uiReact = __webpack_require__(240);

	var _uiReact2 = _interopRequireDefault(_uiReact);
	...
	var Demo = function (_Component) {
	    ...
	    function Demo() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Demo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.animationTrigger = function (name) {
	            if (_this.refs[name].classList.contains(_style2.default['demo__swipe-indicator_animation'])) {
	                _this.refs[name].classList.remove(_style2.default['demo__swipe-indicator_animation']);
	                // Animation dirty hack
	                _this.refs[name].offsetWidth;
	            }

	            _this.refs[name].classList.add(_style2.default['demo__swipe-indicator_animation']);
	        }, _this.onSwipeStart = function () {
	            _this.animationTrigger('swipe-start');
	        }, _this.onSwipeMove = function (x, y) {
	            if (!_this.refs['swipe-move'].classList.contains(_style2.default['demo__swipe-indicator_animation'])) {
	                _this.refs['swipe-move'].classList.add(_style2.default['demo__swipe-indicator_animation']);
	            }
	        }, _this.onSwipeEnd = function (x, y) {
	            _this.animationTrigger('swipe-end');
	            _this.refs['swipe-move'].classList.remove(_style2.default['demo__swipe-indicator_animation']);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _uiReact2.default,
	                        {
	                            className: _style2.default['demo__swipe-block'],
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { className: _style2.default['demo__swipe-indicators'] },
	                    _react2.default.createElement('li', { ref: 'swipe-start', className: _style2.default['demo__swipe-indicator'], 'data-label': 'onSwipeStart' }),
	                    _react2.default.createElement('li', { ref: 'swipe-move', className: _style2.default['demo__swipe-indicator'], 'data-label': 'onSwipeMove' }),
	                    _react2.default.createElement('li', { ref: 'swipe-end', className: _style2.default['demo__swipe-indicator'], 'data-label': 'onSwipeEnd' })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"demo__swipe-block":"_1EHKzqXxBQ1ZXjQL7Hutld","demo__swipe-indicators":"p0QcD3GBvKj9aBzL4YLX8","demo__swipe-indicator":"_1FLzzgCOW2_drwWnTpoBZF","demo__swipe-indicator_animation":"L264YBkEY93Kp2sd5x0yN","bounceOut":"_3XAX1xQVst_7o3Arq0YgPO","bounceOutMini":"_1mTahKe8KKuhV5VnLfLbF_"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Swipe = function (_Component) {
	    ...
	    function Swipe() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Swipe)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onTouchStart = function (e) {
	            if (e.changedTouches.length == 1 && !_this._started && !_this._detecting) {
	                _this._detecting = true;

	                _this._touch = e.changedTouches[0];
	                _this._positionStart = {
	                    x: _this._touch.pageX,
	                    y: _this._touch.pageY
	                };
	            }
	        }, _this.onTouchMove = function (e) {
	            if (_this._detecting || _this._started) {
	                if (_this._detecting && _this.validateTouch(e.changedTouches)) {
	                    var x = _this._positionStart.x - e.changedTouches[0].pageX,
	                        y = _this._positionStart.y - e.changedTouches[0].pageY;

	                    switch (_this.props.axis) {
	                        case 'x':
	                    ...
	                    _this._detecting = false;
	                }

	                if (_this._started && _this.validateTouch(e.changedTouches)) {
	                    e.preventDefault();

	                    var _x = _this._positionStart.x - e.changedTouches[0].pageX,
	                        _y = _this._positionStart.y - e.changedTouches[0].pageY;

	                    _this.onSwipeMove(_x, _y);

	                    _this._positionDelta = {
	                        x: _x,
	                        y: _y
	                    };
	                }
	            }
	        }, _this.onTouchComplete = function (e) {
	            if (_this._started && _this.validateTouch(e.changedTouches)) {
	                e.preventDefault();

	                _this.swipeAction().onSwipeEnd().clean();
	            }

	            return _this;
	        }, _this.onTouchEnd = _this.onTouchComplete, _this.onTouchCancel = _this.onTouchComplete, _this.onSwipeStart = function () {
	            _this.props.onSwipeStart && _this.props.onSwipeStart();

	            return _this;
	        }, _this.onSwipeMove = function (x, y) {
	            _this.props.onSwipeMove && _this.props.onSwipeMove(x, y);
	            ...
	            return _this;
	        }, _this.swipeAction = function () {
	            if (_this.isSwipeHandler) {
	                if (!_this.props.axis || _this.props.axis == 'x') {
	                    if (_this.props.axis == 'x') {
	                        _this.swipeX();
	                    } else {
	                        if (Math.abs(_this._positionDelta.x) > Math.abs(_this._positionDelta.y)) {
	                            _this.swipeX();
	                        }
	                    }
	                }

	                if (!_this.props.axis || _this.props.axis == 'y') {
	                    if (_this.props.axis == 'y') {
	                        _this.swipeY();
	                    } else {
	                        if (Math.abs(_this._positionDelta.y) > Math.abs(_this._positionDelta.x)) {
	                            _this.swipeY();
	                        }
	                    }
	                }
	            ...
	            return _this;
	        }, _this.swipeY = function () {
	            if (_this.props.minDelta < Math.abs(_this._positionDelta.y)) {
	                if (_this._positionDelta.y > 0) {
	                    _this.props.onSwipeUp && _this.props.onSwipeUp();
	                } else if (_this._positionDelta.y < 0) {
	                    _this.props.onSwipeDown && _this.props.onSwipeDown();
	                }
	            }
	        }, _this.swipeX = function () {
	            if (_this.props.minDelta < Math.abs(_this._positionDelta.x)) {
	                if (_this._positionDelta.x > 0) {
	                    _this.props.onSwipeLeft && _this.props.onSwipeLeft();
	                } else if (_this._positionDelta.x < 0) {
	                    _this.props.onSwipeRight && _this.props.onSwipeRight();
	                }
	            }
	        }, _this.clean = function () {
	            _this._positionStart = null;
	            _this._positionDelta = null;
	            _this._started = false;

	            return _this;
	        }, _this.validateTouch = function (touches) {
	            var result = false;

	            for (var i = 0; i < touches.length; i++) {
	                if (_this._touch.identifier == touches[i].identifier) {
	                    result = true;
	                    break;
	                }
	            }
	    ...
	    _createClass(Swipe, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                this.props.tagName,
	                { className: this.props.className, style: this.props.style, onTouchStart: this.onTouchStart, onTouchMove: this.onTouchMove, onTouchEnd: this.onTouchEnd, onTouchCancel: this.onTouchCancel },
	                this.props.children
	            );
	        }
	    }, {
