    ...
    render() {
        return(
            <nav className={style['nav']}>
                <Link to="/docs" className={style['nav__link']}>{i18n.en['nav-docs']}</Link>
                <Link to="/demo" className={style['nav__link']}>{i18n.en['nav-demo']}</Link>
                <Link to="/releases" className={style['nav__link']}>{i18n.en['nav-releases']}</Link>
                <Link to="/discuss" className={style['nav__link']}>{i18n.en['nav-discuss']}</Link>
